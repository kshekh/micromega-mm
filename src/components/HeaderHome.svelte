...
<header
	class="top-0 inset-x-0 z-40 transition-all ease-in-out duration-300  {y
		? 'shadow-md bg-yellow fixed '
		: 'absolute '}"
	class:fixHeader={y >= 2}
>
	<div class="max-w-screen-wrap mx-auto px-5">
		<div class="flex justify-between w-full menubar ">
			<div class="flex items-center">
				<a href="/#" class="flex logo">
					<img
						src="./src/assets/dist/img/logo-white.svg"
						alt=""
						class="lg:h-10 h-4  {y ? 'hidden' : ''}"
					/>
					<img src="Logo.svg" alt="" class="lg:h-10 h-4  {y ? '' : 'hidden'}" />
				</a>
			</div>
			...
			<div class="flex justify-end items-stretch ">
				<a
					href="/#"
					class="flex items-center gap-3 font-bold relative md:pl-10 transition ease-in-out duration-200 group {y
						? 'text-black  p-2 xs:p-4'
						: 'text-yellow p-2 xs:p-4 sm:p-8'}"
				>
					<svg
						class="w-5 md:absolute left-4 md:top-1/2 md:-translate-y-1/2"
						viewBox="0 0 13 13"
						fill="currentColor"
					>
						<path
					...
					<span
						class="md:block hidden relative before:absolute before:inset-x-0 before:-bottom-1 before:border-b before:border-transparent before:translate-y-3 group-hover:before:translate-y-0 before:transition before:ease-in-out before:duration-200 {y
							? 'group-hover:before:border-black  '
							: 'group-hover:before:border-yellow '}">Intéressé·e par l’app ?</span
					>
				</a>
				<a
					href="/#"
				...
				>
					<svg
						class="w-4 md:absolute left-4 md:top-1/2 md:-translate-y-1/2"
						viewBox="0 0 10 15"
						fill="currentColor"
					>
						<path
					...
					<span
						class="md:block hidden relative before:absolute before:inset-x-0 before:-bottom-1 before:border-b before:border-transparent  before:translate-y-3 group-hover:before:translate-y-0 before:transition before:ease-in-out before:duration-200 {y
							? 'group-hover:before:border-black  '
							: 'group-hover:before:border-yellow '}">Se connecter</span
					>
				</a>

				<Menu let:open>
					<MenuButton
						class="flex items-center px-3 sm:px-5 h-full {y ? 'text-black' : 'text-yellow'}"
					>
						{#if !open}
							<svg class="w-7 close" viewBox="0 0 23 7" fill="currentColor">
								<path
									fill-rule="evenodd"
									clip-rule="evenodd"
					...
					<Transition show={open}>
						<MenuItems
							class="bg-yellow py-5 flex flex-col max-h-[calc(100vh-50px)] overflow-auto absolute top-full inset-x-0 shadow-md"
						>
							<div class="max-w-screen-wrap mx-auto px-5 w-full flex-1 md:py-5">
								<Megamenu />
							</div>
						</MenuItems>
					</Transition>
